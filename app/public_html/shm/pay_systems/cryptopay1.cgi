...
if ( $vars{action} eq 'create' ) {
    ...
    my $api_key =        $config->get_data->{cryptopay1}->{api_key};
    my $description =    $config->get_data->{cryptopay1}->{description};
    my $paid_btn_url =    $config->get_data->{cryptopay1}->{paid_btn_url};
    my $paid_btn_name =    $config->get_data->{cryptopay1}->{paid_btn_name};
    my $fiat =    $config->get_data->{cryptopay1}->{fiat};
